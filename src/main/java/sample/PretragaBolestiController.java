...
public class PretragaBolestiController {
    ...
    @FXML
    private TableColumn<Set<Simptom>, String> nazivSimptomStupac;
    @FXML
...
//        System.out.println(filtriranaBolest.get(0).getNaziv());
        ...
        if(filtriranaBolest.isPresent()) {
            ...
            nazivSimptomStupac.setCellValueFactory(new PropertyValueFactory<Set<Simptom>, String>("simptomi"));

            tablicaSimptoma.getItems().setAll(filtriranaBolest.get());
        }
